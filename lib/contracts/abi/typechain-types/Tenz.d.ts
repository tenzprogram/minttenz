...
export interface TenzInterface extends utils.Interface {
    contractName: "Tenz";
    functions: {
    ...
    encodeFunctionData(functionFragment: "addMinterByOwner", values: [string]): string;
    ...
    encodeFunctionData(functionFragment: "setTransferListener", values: [string]): string;
    ...
    encodeFunctionData(functionFragment: "transferListener", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "addMinterByOwner", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "setTransferListener", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "transferListener", data: BytesLike): Result;
...
export declare type SetTransferListenerEvent = TypedEvent<[
    string
], {
    transferListener: string;
}>;
export declare type SetTransferListenerEventFilter = TypedEventFilter<SetTransferListenerEvent>;
...
export interface Tenz extends BaseContract {
    contractName: "Tenz";
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: TenzInterface;
    ...
    functions: {
        ...
        addMinterByOwner(account: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        setTransferListener(_transferListener: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        totalSupply(overrides?: CallOverrides): Promise<BigNumber>;
        setTransferListener(_transferListener: string, overrides?: CallOverrides): Promise<void>;
    ...
    filters: {
        ...
        "SetTransferListener(address)"(transferListener?: null): SetTransferListenerEventFilter;
        SetTransferListener(transferListener?: null): SetTransferListenerEventFilter;
...
//# sourceMappingURL=Tenz.d.ts.map