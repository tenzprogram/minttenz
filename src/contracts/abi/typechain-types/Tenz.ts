...
export type SetTransferListenerEvent = TypedEvent<
  [string],
  { transferListener: string }
>;

export type SetTransferListenerEventFilter =
  TypedEventFilter<SetTransferListenerEvent>;
...
export interface Tenz extends BaseContract {
  ...
  filters: {
    ...
    ): SetTransferListenerEventFilter;
    SetTransferListener(
      transferListener?: null
    ): SetTransferListenerEventFilter;
